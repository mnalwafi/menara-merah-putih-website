...
/**
 * List of image paths used for the hero section background carousel.
 * Ensure these images exist in the public directory.
 * @type {string[]}
 */
const heroImages = [
  "/hero-image-1.webp",
...
/**
 * Represents a service offering displayed in the services grid.
 *
 * @typedef {Object} ServiceItem
 * @property {string} title - The display title of the service.
 * @property {string} description - A brief summary of the service.
 * @property {LucideIcon} icon - The Lucide icon component representing the service.
 * @property {string} linkText - The text to display on the 'read more' link.
 * @property {"eco" | "brand"} theme - The color theme for the card (affects styling).
 * @property {string} href - The navigation destination for the service.
 */

/**
 * Configuration array for the Integrated Mining Services section.
 * @type {ServiceItem[]}
 */
const services = [
  {
...
/**
 * Statistical data points displayed in the stats strip.
 * @type {{ label: string, value: string }[]}
 */
const stats = [
  { label: "Safety Record", value: "Zero LTI" },
  { label: "Product Range", value: "20+ Agents" },
  { label: "Safe Manhours", value: "480k+" },
  { label: "Total Client", value: "10+" },
];

/**
 * The main client-side landing page component.
 *
 * Features:
 * - Background Image Carousel: Cycles through `heroImages` every 5 seconds.
 * - Hero Section: Displays main value proposition with entry animations.
 * - Stats Strip: Displays key performance indicators.
 * - Services Grid: Iterates through `services` data to render feature cards.
 * - NEDA Comparison Teaser: A promotional section comparing NEDA to traditional blasting.
 *
